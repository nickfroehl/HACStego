...
void* fLSB_Red(struct PixelData *pd, unsigned char flag);
...
void* fLSB_Blue(struct PixelData *pd, unsigned char flag);
...
void* fLSB_Green(struct PixelData *pd, unsigned char flag);
...
void* fLSB_RGB(struct PixelData *pd, unsigned char flag);
